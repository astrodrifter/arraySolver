/* NOTE TO MARKER
 * When you test data you will need to be aware of how my solution 
 * reads in data and where it is done in my solution.
 * The following code is used to read in test#.txt test data,
 * fopen("../test26.txt", "r"), found in getSize() function on line 144 
 * and also in fillArray() function on line 165 of my code solution.
 * 
 * INTRODUCTION
